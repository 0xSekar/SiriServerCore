...
from siriObjects.systemObjects import StartRequest, SendCommands, CancelRequest, \
    ...
    AssistantCreated, SetAssistantData, SetAlertContext, ClearContext, LoadAssistant, AssistantNotFound, \
...
class SiriProtocolHandler(Siri):
    __not_recognized = {"de-DE": u"Entschuldigung, ich verstehe \"{0}\" nicht.", "en-US": u"Sorry I don't understand {0}", "fr-FR": u"Désolé je ne comprends pas ce que \"{0}\" veut dire.", "nl-NL": u"Excuses, \"{0}\" versta ik niet.", "es-AR": u"Lo siento, no entiendo \"{0}\"."}
    __websearch = {"de-DE": u"Websuche", "en-US": u"Websearch", "fr-FR": u"Rechercher sur le Web", "nl-NL": u"Zoeken op het web", "es-AR": u"Buscar en la Web"}
